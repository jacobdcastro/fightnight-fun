...
contract ProgrammableTokenTransfers is CCIPReceiver, OwnerIsCreator {
    ...
    constructor(address _router, address _link, address[] memory _owners, address _appBridge) CCIPReceiver(_router) {
        owners = _owners;
    ...
    function constructMessage(
        ...
        return _buildCCIPMessage(_receiver, _text, _token, _amount, _feeTokenAddress);
    }
